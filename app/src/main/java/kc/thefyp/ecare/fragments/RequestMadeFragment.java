...
public class RequestMadeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_request_made, container, false);
    ...
    private void loadData() {
        ...
        reference.orderByChild("fromUser").equalTo(user.getId()).addValueEventListener(new ValueEventListener() {
