...
public class DonationReceivedFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public DonationReceivedFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View root = inflater.inflate(R.layout.fragment_donation_received, container, false);
    ...
    private void loadData() {
        ...
        reference.orderByChild("donatedTo").equalTo(user.getId()).addValueEventListener(new ValueEventListener() {
